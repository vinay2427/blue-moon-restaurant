(function ($) {
    ...
    if ($.fn.owlCarousel) {
        ...
        wel_slides.on('translate.owl.carousel', function (event) {
            ...
            $('.hero-slides-nav, .kt-hero-area .owl-next').removeClass('animated').hide();
        })
        wel_slides.on('translated.owl.carousel', function (event) {
            ...
            $('.hero-slides-nav, .kt-hero-area .owl-next').addClass('animated fadeInUp').show();
        })
        // Testimonials Slider Active Code
        $(".kt-testimonials-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 1500,
    ...
    if ($.fn.imagesLoaded) {
        $('.kt-portfolio').imagesLoaded(function () {
